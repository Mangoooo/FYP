...
//////////////////////////////////////Preload////////////////////////////////////////
    preload: function()
    {
		...
		this.blue = this.add.sprite(this.world.width*0.4, this.world.height*0.7, 'blue');
        this.blue.anchor.set(0.5,0.5);
		this.blue.inputEnabled = true;
		this.blue.events.onInputDown.add(this.blueclick, this);
		
		this.green = this.add.sprite(this.world.width*0.5, this.world.height*0.7, 'green');
        this.green.anchor.set(0.5,0.5);
		this.green.inputEnabled = true;
		this.green.events.onInputDown.add(this.greenclick, this);
		
		this.yellowGem = this.add.sprite(this.world.width*0.6, this.world.height*0.7, 'yellow');
		...
		this.cyanGem = this.add.sprite(this.world.width*0.7, this.world.height*0.7, 'cyan');
		...
		//customer icon
		this.iconImage = this.add.sprite(this.world.width*0.4, this.world.height*0.08, 'customerIcon');
...
//		this.clockImage.lineStyle(2, 0xaffffff);
//		this.clockImage.beginFill(928325);
//		this.clockImage.arc(80, 550, 50, this.angle.min, this.math.degToRad(this.angle.max), true); //x positon, y position, scale 
//		this.clockImage.endFill();

		
		this.clockSkin = this.add.sprite(this.world.width*0.1, this.world.height*0.85, 'clockskin');
        this.clockSkin.anchor.set(0.5,0.5);
		this.clockSkin.scale.setTo(0.8,0.8);
		
		this.clockImage = this.add.sprite(this.world.width*0.1, this.world.height*0.85, 'clock');
		...
		this.CusNumText = this.add.text(410, 40, ' : 0', { font:"30px Arial", fill: "#000", align: "center"});
    }, 
    ...
    create: function()
    {
		...
		//this.clockImage = this.add.tween(this.angle).to({max: 359 }, 20000, "Linear", true); //10000   = 10		
    },
	...
	blueCustomerFunc: function()
	{
		...
		{
			//this.TheDestroyer(this.bubble,this);
		}
