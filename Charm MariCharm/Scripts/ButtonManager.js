...
{
    this.nextButton = this.game.add.button(posx, posy, 'nextScoreButton', this.gotoLevel2, this, 0, 0, 1);
...
ButtonManager.prototype.createLevel3Button = function(posx, posy)
{
    ...
    this.level2Button = this.game.add.button(posx, posy, 'nextScoreButton', this.gotoLevel3, this,  0, 0, 1);
...
ButtonManager.prototype.CreateTotalMoney = function(posx, posy)
{
    this.scoreButton = this.game.add.button(posx, posy, 'nextScoreButton', this.TotalMoney, this,  0, 0, 1);
    this.scoreButton.anchor.set(0.5,0.5);
},	
	
ButtonManager.prototype.TotalMoney = function() 
{
	this.gametype = 8;
	this.nextLevelClick = true;
	theGame.FadeScreen.OnEnd = true;
...
ButtonManager.prototype.CreateGameEnd = function(posx, posy)
{
    this.scoreButton = this.game.add.button(posx, posy, 'nextScoreButton', this.GameEndScreen, this,  0, 0, 1);
    this.scoreButton.anchor.set(0.5,0.5);
},	
	
ButtonManager.prototype.GameEndScreen = function() 
{
	this.gametype = 9;
	this.nextLevelClick = true;
	theGame.FadeScreen.OnEnd = true;
...
ButtonManager.prototype.Level3ScoreButton = function(posx, posy)
{
    this.scoreButton = this.game.add.button(posx, posy, 'nextButton', this.gotoScorePage3, this,  0, 0, 1);
    this.scoreButton.anchor.set(0.5,0.5);
},	
	
ButtonManager.prototype.gotoScorePage3 = function() 
{
	this.gametype = 7;
	this.nextLevelClick = true;
	theGame.FadeScreen.OnEnd = true;
